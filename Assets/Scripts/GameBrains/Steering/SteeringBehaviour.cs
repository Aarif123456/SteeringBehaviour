...
namespace GameBrains.Steering
{
    ...
    public class SteeringBehaviour : MonoBehaviour
    {
        ...
        // How close must we be before we stop seeking.
        public float satisfactionRadius = 0.1f;

        protected Vector3 desiredMoveDirection;

        // Uncomment the next line to see distance to target in the inspector view.
        [SerializeField]
        protected float distanceToTarget;

        // The motor controlling the bot.
        public Motor motor;
        ...
        public virtual void Update()
        {
            ...
            //motor.DesiredSpeedFactor = 1.0f; // seek at maximum speed (arrive should slow on approach)
        }

        // OnDisable is called when this behaviour becomes disabled or inactive.
        // This is also called when the object is destroyed.
        public void OnDisable()
        {
            // Stop motor.
            motor.desiredMoveDirection = Vector3.zero;
