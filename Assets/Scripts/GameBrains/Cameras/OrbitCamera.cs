...
{
    [AddComponentMenu("Scripts/Camera/Orbit Camera")]

    // Require a camera to be attached to the parent game object.
    ...
    public class OrbitCamera : TargetedCamera
    {
        ...
        // If this behavior is enabled, Start is called once
        ...
        // If this behavior is enabled, LateUpdate is called once per frame
        ...
        {
            if (Physics.Raycast(target, direction, out RaycastHit hit, distance, lineOfSightMask.value))
            {
